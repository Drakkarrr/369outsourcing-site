          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                <h1 className="text-dark mb-3 text-4xl font-bold leading-snug text-black sm:text-[42px] lg:text-[40px] xl:text-[42px]">
                  From idea to reality with 369OutsourcingSolutions
                </h1>
                <p className="text-body-color mb-8 max-w-[480px] text-base text-black">
                  With 369outsourcing solutions, business and startups thrive
                  together. Business can perfectly match their staffing to
                ...
                <ul className="flex flex-wrap items-center">
                  <li>
                    <a
                      ...
                      className="bg-primary inline-flex items-center justify-center rounded-lg border bg-blue-300 py-4 px-6 text-center text-base font-normal text-black hover:bg-opacity-90 sm:px-10 lg:px-8 xl:px-10"
                    >
                      Get Started
                    </a>
                  </li>
                ...
                <div className="clients pt-16">
                  <h6 className="text-body-color mb-2 flex items-center text-xs font-normal text-black">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/3 ">
              <div className="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                <div className="bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-blue-400">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
