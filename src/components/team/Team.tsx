          ...
          <div className="mx-auto mb-10 max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            <div className="card mx-auto max-w-lg text-center">
              ...
              <p className="subhead mt-4 text-gray-300">
                ...
                work ethic, and ability to work well under pressure. Our diverse
                backgrounds and experiences allow us to bring a variety of
                perspectives to the table, enabling us to tackle complex
                challenges with creativity and innovation. We are committed to
                continuous learning and growth, staying up-to-date with the
                latest industry trends and technologies. Above all, we are a
                team that values collaboration, respect, and integrity, working
                ...
                <div className="mx-auto mb-10 w-full max-w-[370px]">
                  <div className="relative overflow-hidden rounded-lg">
                    <img
                      ...
                      alt="Sevefourd profile"
                      className="w-full"
                    />
                    <div className="absolute bottom-5 left-0 w-full text-center">
                      <div className="relative mx-5 overflow-hidden rounded-lg bg-white py-5 px-3">
                        <h3 className="text-dark text-base font-semibold text-black">
                          Sevefourd
                        </h3>
                        <p className="text-body-color text-sm text-black">
